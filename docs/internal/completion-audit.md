...
| Candlestick                     | OHLC geometry, volume, tap tooltip, calendar-aware session-gap markers, US equities exchange presets, early-close/emergency-closure markers, financial narrative helper, viewport gestures, range selector, scrollable preview | Covered as financial preview                                                                                    |
...
| Advanced financial presets   | No named early-close calendar presets or emergency-closure feed integration                                     | Financial chart remains preview, not a complete Pro financial chart                           |
