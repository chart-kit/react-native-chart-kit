...
| Candlestick                     | OHLC geometry, volume, tap tooltip, calendar-aware session-gap markers, US equities exchange presets, financial narrative helper, viewport gestures, range selector, scrollable preview | Covered as financial preview                                                                                    |
...
| Advanced financial scope     | No early-close handling or emergency market closures                                                            | Financial chart remains preview, not a complete Pro financial chart                           |
