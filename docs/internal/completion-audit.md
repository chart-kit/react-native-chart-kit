...
| Candlestick                     | OHLC geometry, volume, tap tooltip, calendar-aware session-gap markers, US equities full-day/early-close presets, emergency-closure markers, financial narrative helper, viewport gestures, range selector, scrollable preview | Covered as financial preview                                                                                    |
...
| Advanced financial feeds     | No emergency-closure feed integration                                                                           | Financial chart remains preview, not a complete Pro financial chart                           |
