...
| Candlestick                     | OHLC geometry, volume, tap tooltip, calendar-aware session-gap markers, US equities exchange presets, viewport gestures, range selector, scrollable preview            | Covered as financial preview                                                                                    |
...
| Advanced financial scope     | No early-close handling, emergency market closures, or advanced financial narratives    | Financial chart remains preview, not a complete Pro financial chart                           |
