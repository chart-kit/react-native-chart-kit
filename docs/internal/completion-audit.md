...
| Native release workflow         | `.github/workflows/native-release.yml`, `scripts/run-expo-native-release-check.mjs`, `docs/release/native-release-checks.md` | Configured; green workflow artifacts still missing                  |
...
| ---------------------------- | ---------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| Native iOS release build     | No green native release-build workflow artifact                        | Required before production beta/RC confidence                                                 |
| Native Android release build | No green native release-build workflow artifact                        | Required before production beta/RC confidence                                                 |
