...
| Public surface audit   | `npm run surface:check`               | Passed: compatibility exports, free/baseline modern exports, `@chart-kit/react-native/pro-preview`, Pro-candidate metadata, and package-boundary audit |
...
| Public export surface   | `scripts/verify-public-surface.mjs`; `scripts/verify-package-boundaries.mjs`; `npm run surface:check`                                                               | Covered for root compatibility exports, free/baseline modern v2 exports, React Native Pro preview subpath exports, Pro-candidate metadata, and package-boundary constraints                                                                                                                                                                                                                       |
