...
| Pro package boundary    | `packages/pro`; `npm run pro:typecheck`                                                                                                                             | Preview feature registry and surface-boundary metadata now mirror the H4 commercial buckets: layout engine, interactions, chart types, export, templates, performance, Skia, and accessibility reports. License gating and paid implementations still pending H4                                                                                                                                    |
