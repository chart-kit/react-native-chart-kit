...
| Visual baseline         | `apps/expo-showcase/visual/__screenshots__`; `npm run test:visual`                                                                                                  | Covered for 74 chart-story screenshots plus 21 interaction tests                                                                                                                                                                                                                                                                                                                                    |
...
| Native runtime QA       | [Native runtime QA protocol](native-runtime-qa.md); `npm run test:e2e`; `npm run test:visual`                                                                       | Protocol exists; iOS simulator release smoke screenshot captured; manual iOS/Android gesture/runtime evidence still pending                                                                                                                                                                                                                                                                         |
