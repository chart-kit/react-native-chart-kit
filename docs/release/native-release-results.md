...
| Native Release Checks workflow   | Passed on `next` for commit `54ff30a5fe524eacbec1d39f87347bf36740d13a` with archived platform artifacts. |
...
The GitHub `Native Release Checks` workflow configures Java and runs on an Android-capable hosted runner. On May 6, 2026, run `25419774495` passed both iOS and Android release-build jobs for commit `54ff30a5fe524eacbec1d39f87347bf36740d13a`.

The recorded artifacts are:

- iOS artifact: `https://github.com/indiespirit/react-native-chart-kit/actions/runs/25419774495/artifacts/6823977013`
- Android artifact: `https://github.com/indiespirit/react-native-chart-kit/actions/runs/25419774495/artifacts/6824017644`

The evidence was recorded with:

```sh
npm run release:native-workflow:record -- \
  --run-url https://github.com/indiespirit/react-native-chart-kit/actions/runs/25419774495 \
  --commit 54ff30a5fe524eacbec1d39f87347bf36740d13a \
  --ios-artifact https://github.com/indiespirit/react-native-chart-kit/actions/runs/25419774495/artifacts/6823977013 \
  --android-artifact https://github.com/indiespirit/react-native-chart-kit/actions/runs/25419774495/artifacts/6824017644
```
