...
| Finance           | finished candlestick/financial module, market-session gaps, volume overlays, range selector polish |
...
4. Yes, but only as Financial Preview until market-session gaps and native performance are proven.
