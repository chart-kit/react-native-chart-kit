...
The Skia path is still preview-only: sticky axis labels require a Skia font, and gradient area fills, native install verification, and native renderer parity tests are still pending.
