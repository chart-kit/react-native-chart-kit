...
The Skia path is still preview-only: sticky axis labels require a Skia font, and gradient area fills, native install verification, and renderer parity tests are still pending.
