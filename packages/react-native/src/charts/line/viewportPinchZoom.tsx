...
import {
  ...
  type ResolvedLineChartViewportInteractionConfig
...
export const useLineChartViewportPinchZoom = ({
  dataLength,
  enabled,
  onViewportChange,
  plotBounds,
  ...
  const configRef = useRef<ResolvedLineChartViewportInteractionConfig>(config);
  ...
  const handleUpdate = useCallback(
    (event: { focalX: number; scale: number }) => {
      ...
      const nextWindow = resolveChartViewportWindowFromZoom({
        ...
        zoomFactor: getLineChartViewportPinchZoomFactor({
          scale: event.scale,
...
export const LineChartViewportGesture = ({
  children,
  gesture
}: {
  children: ReactNode;
