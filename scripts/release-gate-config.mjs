export const requiredFiles = [
  ...
  "scripts/generate-native-qa-signoff.mjs",
  ...
  "scripts/capture-ios-performance-evidence.mjs",
  "scripts/ios-performance-evidence-format.mjs",
...
export const requiredScripts = [
  ...
  "release:qa:signoff",
  "release:qa:signoff:check",
  "release:qa:status",
  "release:qa:capture",
  "release:performance:android",
  "release:performance:ios",
  "release:qa:record",
